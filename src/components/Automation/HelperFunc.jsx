...
HelperFunc.propTypes = {
  data: PropTypes.any, // This can be any type of data
  ...
  deviceData: PropTypes.func.isRequired,
  timeData: PropTypes.func.isRequired,
  waitData: PropTypes.func.isRequired,
  nodesData: PropTypes.any, // This can be any type of data
};
